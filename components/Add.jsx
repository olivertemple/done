                ...
                <View>
                    ...
                    <View>
                        <View style={{marginTop:20}}>
                            ...
                            <TextInput ref={this.key1} placeholder="Title" style={{fontSize:16, padding:10, borderRadius:5, backgroundColor:"#E8E8E8", marginTop:5, fontFamily:"regular", backgroundColor:this.props.theme==="light" ? "#E8E8E8" : "#282828", color:this.props.theme==="light" ? "black" : "#E3E3E3"}} onChangeText={text => {this.updateTitle(text)}} placeholderTextColor={this.props.theme==="dark" ? "#E3E3E3" : "grey"}></TextInput>
                        ...
                        <View style={{marginTop:20}}>
                            ...
                            <View style={{flexDirection:"row", alignItems:"center", marginTop:5,}}>
                                <View style={{backgroundColor:this.props.theme==="light" ? "#E8E8E8" : "#282828", color:this.props.theme==="light" ? "black" : "#E3E3E3", flexDirection:"row", alignItems:"center", paddingRight:10,borderRadius:5}}>
                                    <TextInput keyboardType="numeric" placeholder="1" style={{fontFamily:"regular", fontSize:16, padding:10, borderRadius:5, alignSelf:"flex-start",  backgroundColor:this.props.theme==="light" ? "#E8E8E8" : "#282828", color:this.props.theme==="light" ? "black" : "#E3E3E3"}} onChangeText={text =>{this.setState({times:text})}} ref={this.key2} onFocus={() => {this.setState({showCross:true})}} onBlur={() => {this.setState({showCross:false})}} placeholderTextColor={this.props.theme==="dark" ? "#E3E3E3" : "grey"}>{this.state.times===1 ? null : this.state.times}</TextInput>
