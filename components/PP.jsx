        ...
        return(
            <View style={{position:"absolute", backgroundColor:"white", borderRadius:10, borderWidth:2, borderColor:"black", padding:10, zIndex:5, elevation:1, shadowColor:"#000", shadowOffset:{
                ...
                <View style={{marginTop:10}}>
                    ...
                    <Text style={{fontSize:16,fontFamily:"regular"}}>Your data is only used for the functions of the app. When the app is deleted, so is your data.</Text>
                </View>
                <TouchableOpacity onPress={this.props.cancel} style={{marginTop:10}}>
                    <View style={{justifyContent:"center", alignItems:"center"}}>
                        <Image source={require("../assets/cancel.png")} style={{height:25, width:25, tintColor:"#C5C5C5"}}></Image>
                    </View>
                </TouchableOpacity>
            </View>
        )
